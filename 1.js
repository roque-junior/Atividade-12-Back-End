...
// nome 'Eva Trindade'.
console.log( "8. Utilize a função findIndex, para descobrir a posição da pessoa de nome 'Eva Trindade'.")


let evatrindade = pessoas.findIndex(function(banana) {
    return banana.nome === "Eva Trindade"
})
...
console.log (
 ...
 let silvas = pessoas.filter(function (banana) {
          return banana.nome.includes("Silva")
  })
...
let Nomes = pessoas.map(function(banana) {
return {
    nome: banana.nome
}
